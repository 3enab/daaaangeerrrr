...
module.exports = {
  ...
  async execute(message, args, client) { 
    ...
    if (!data.system.giftsCode.map( e => e.code ).includes(code)) return message.channel.send("**That code does not exist!**");
    ...
    message.channel.send("**This code has been deleted successfully!**");
