...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    var coins = data.profile.coins;
    coins.shift();
    coins = coins.filter(e => e.server == message.guild.id).length;
    
    const canvas = createCanvas(608, 608);
    const ctx = canvas.getContext("2d");
    const image = "https://probot.media/store/574.png";
    const background = await loadImage(image);
    let badges = [
      "https://cdn.probot.io/badges/yemen.png",
      "https://cdn.probot.io/badges/palestine.png",
      "https://cdn.probot.io/badges/syria.png",
      "https://cdn.probot.io/badges/vietnam.png"
    ];
    badges = [badges[0]];
